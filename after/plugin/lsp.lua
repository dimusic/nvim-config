...
lsp.on_attach(function(client, bufnr)
	...
	vim.keymap.set('n', '<C-]>', function() vim.lsp.buf.definition() end, { buffer = bufnr, remap = false, desc = "Go to Definition" })
	vim.keymap.set('n', '<leader>]', ":vsp<cr> :lua vim.lsp.buf.definition()<cr>", { buffer = bufnr, remap = false, desc = "Go Definition (New Split)" })
	vim.keymap.set('n', 'K', function() vim.lsp.buf.hover() end, { buffer = bufnr, remap = false, desc = "Hover Definition" })
	...
	vim.keymap.set('n', '<leader>lR', function() vim.lsp.buf.references() end, { buffer = bufnr, remap = false, desc = "References" })
